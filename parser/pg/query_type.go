...
func (q *queryTypeListener) EnterStmtblock(ctx *pgparser.StmtblockContext) {
	multi := ctx.Stmtmulti()
...
func (q *queryTypeListener) getStatementType(stmt pgparser.IStmtContext) base.QueryType {
	if stmt == nil {
...
func (q *queryTypeListener) hasIntoClause(selectStmt pgparser.ISelectstmtContext) bool {
...
func (*queryTypeListener) hasIntoClauseInSelectNoParens(selectNoParens pgparser.ISelect_no_parensContext) bool {
...
func (*queryTypeListener) hasAnalyzeOption(explainStmt pgparser.IExplainstmtContext) bool {
	if explainStmt == nil {
		return false
	}
