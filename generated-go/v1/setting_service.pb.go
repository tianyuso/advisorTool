...
const file_v1_setting_service_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x12.bytebase.v1.ValueR\x05value\"\xe3\x02\n" +
	...
	"\x14bytebase.com/Setting\x12\x12settings/{setting}J\x04\b\x10\x10\x11\"\xe4\a\n" +
	"\x05Value\x12#\n" +
	...
	"\x05valueJ\x04\b\x12\x10\x13\"\xd3\x06\n" +
	"\fAppIMSetting\x12?\n" +
	...
	"\n" +
	"robot_code\x18\x03 \x01(\tB\x03\xe0A\x04R\trobotCode\x1a\xeb\x02\n" +
	"\tIMSetting\x12-\n" +
	...
	"\bdingtalk\x18\x06 \x01(\v2\".bytebase.v1.AppIMSetting.DingTalkH\x00R\bdingtalkB\t\n" +
	"\apayload\"\xff\x05\n" +
	...
	"\x17enable_audit_log_stdout\x18\x0f \x01(\bR\x14enableAuditLogStdout\"\xc2\x01\n" +
	"\fAnnouncement\x12:\n" +
	...
	"\acatalog\x18\x05 \x01(\v2\x19.bytebase.v1.TableCatalogR\acatalog\"\x8a\x06\n" +
	...
	"\x0fcom.bytebase.v1B\x13SettingServiceProtoP\x01Z4advisorTool/generated-go/v1\xa2\x02\x03BXX\xaa\x02\vBytebase.V1\xca\x02\vBytebase\\V1\xe2\x02\x17Bytebase\\V1\\GPBMetadata\xea\x02\fBytebase::V1b\x06proto3"
...
func file_v1_setting_service_proto_init() {
	...
	file_v1_setting_service_proto_msgTypes[24].OneofWrappers = []any{
